-- Expand the model provider allowlist without changing the legacy storage shape.
...
CREATE TABLE models_029 (
  ...
  provider TEXT NOT NULL DEFAULT 'nvidia' CHECK (provider IN ('nvidia', 'openai_compatible', 'opencode_free')),
