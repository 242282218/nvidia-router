CREATE TABLE proxy_pool_settings_safe (
...
INSERT INTO proxy_pool_settings_safe (
  id, enabled, proxy_url, auth_key_nonce, auth_key_ciphertext,
  version, key_version, updated_at
)
SELECT
  id, enabled, proxy_url, auth_key_nonce, auth_key_ciphertext,
  version, key_version, updated_at
...
ALTER TABLE proxy_pool_settings_safe RENAME TO proxy_pool_settings;
