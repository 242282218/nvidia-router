...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'input-field': 'w-full rounded-lg border border-[var(--color-border-strong)] bg-[var(--color-sunken)] px-3 py-2.5 text-sm text-[var(--color-text)] placeholder:text-[var(--color-text-subtle)] transition-colors duration-200 focus:border-[var(--color-focus)] focus:outline-none focus:ring-2 focus:ring-[var(--color-focus)]/35 disabled:cursor-not-allowed disabled:opacity-60',
    ...
    'page-title': 'text-xl font-semibold text-[var(--color-text)] sm:text-2xl',
