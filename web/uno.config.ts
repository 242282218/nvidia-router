...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'btn-danger': 'inline-flex min-h-11 items-center justify-center rounded-lg border border-[#7f1d1d] bg-transparent px-3 py-2 text-sm font-medium text-[#fca5a5] transition-colors duration-200 hover:border-[#991b1b] hover:bg-[#7f1d1d]/30 active:bg-[#7f1d1d]/50 disabled:cursor-not-allowed disabled:opacity-40 focus-visible:outline-2 focus-visible:outline-[var(--color-focus)] focus-visible:outline-offset-2',
    ...
    'badge-success': 'badge border-[#22c55e]/25 bg-[#22c55e]/10 text-[var(--color-success)]',
    'badge-warning': 'badge border-[#f59e0b]/25 bg-[#f59e0b]/10 text-[var(--color-warning)]',
    'badge-danger': 'badge border-[#ef4444]/25 bg-[#ef4444]/10 text-[var(--color-danger)]',
    'badge-muted': 'badge border-white/10 bg-white/5 text-[var(--color-text-secondary)]',
    'badge-info': 'badge border-indigo-400/25 bg-indigo-400/10 text-[var(--color-info)]',
