...
<template>
  <div class="relative">
    ...
    <div
      ...
      class="chart-tooltip pointer-events-none absolute top-6 z-[var(--z-popover)] min-w-32 max-w-[calc(100vw-2rem)] rounded-[var(--radius-control)] border border-[var(--color-border)] bg-[var(--color-surface-raised)] px-3 py-2"
